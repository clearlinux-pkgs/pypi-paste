...
%prep
%setup -q -n Paste-3.5.1
cd %{_builddir}/Paste-3.5.1
pushd ..
cp -a Paste-3.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655910482
...
cp %{_builddir}/Paste-3.5.1/docs/license.txt %{buildroot}/usr/share/package-licenses/pypi-paste/391729571488896efa70494919f96aab67116ad1
