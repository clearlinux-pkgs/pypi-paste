...
Version  : 3.6.1
Release  : 106
URL      : https://files.pythonhosted.org/packages/0b/f1/ccfbeb98fa3843fb031bde9e1d91cbd4a92270c4a28a9253dfc4edf913ce/Paste-3.6.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/0b/f1/ccfbeb98fa3843fb031bde9e1d91cbd4a92270c4a28a9253dfc4edf913ce/Paste-3.6.1.tar.gz
...
%prep
%setup -q -n Paste-3.6.1
cd %{_builddir}/Paste-3.6.1
pushd ..
cp -a Paste-3.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697471613
