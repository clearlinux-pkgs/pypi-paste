...
Version  : 3.8.0
Release  : 109
URL      : https://files.pythonhosted.org/packages/21/24/5a44defe742dafb0b9fa524e93618383089e18f3dda77fdb34ae320d6b4e/Paste-3.8.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/21/24/5a44defe742dafb0b9fa524e93618383089e18f3dda77fdb34ae320d6b4e/Paste-3.8.0.tar.gz
...
%prep
%setup -q -n Paste-3.8.0
cd %{_builddir}/Paste-3.8.0
pushd ..
cp -a Paste-3.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710609552
